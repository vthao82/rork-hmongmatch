...
const s = StyleSheet.create({
  ...
  headerTitle: { color: "#FFF", fontSize: 20, fontFamily: "Cinzel_700Bold", flex: 1 },
  section: { paddingHorizontal: 16, marginTop: 20 },
  sTitle: { color: "#FFF", fontSize: 16, fontFamily: "Cinzel_700Bold", marginBottom: 10 },
  ...
  rowLabel: { color: "#FFF", fontSize: 15, fontFamily: "Cinzel_600SemiBold", flexShrink: 1 },
  ...
  link: { color: Colors.primary, fontSize: 14, fontFamily: "Cinzel_700Bold", marginTop: 10 },
  ...
  modalTitle: { color: "#FFF", fontSize: 17, fontFamily: "Cinzel_700Bold", flex: 1, textAlign: "center", paddingHorizontal: 8 },
  modalSave: { color: Colors.primary, fontSize: 15, fontFamily: "Cinzel_700Bold" },
  ...
  optLabel: { color: "#FFF", fontSize: 15, fontFamily: "Cinzel_600SemiBold" },
  ...
  planTitle: { color: "#FFF", fontSize: 16, fontFamily: "Cinzel_700Bold" },
  planSub: { color: "rgba(255,255,255,0.65)", fontSize: 12, marginTop: 2 },
  upgradeLink: { color: Colors.accent, fontSize: 14, fontFamily: "Cinzel_700Bold" },
  ...
  toastTxt: { color: Colors.like, fontSize: 12, fontFamily: "Cinzel_700Bold" },
});

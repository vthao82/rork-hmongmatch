...
const s = StyleSheet.create({
  ...
  heroTitle: { color: "#FFF", fontSize: 22, fontFamily: "Cinzel_700Bold", textAlign: "center" as const, marginTop: 6 },
  ...
  sectionTitle: { color: "#FFF", fontSize: 16, fontFamily: "Cinzel_700Bold" },
  seeAll: { color: Colors.accent, fontSize: 13, fontFamily: "Cinzel_600SemiBold" },
  ...
  proPillTxt: { color: Colors.accent, fontSize: 10, fontFamily: "Cinzel_700Bold" },
  ...
  badgeTxt: { color: "#FFF", fontSize: 11, fontFamily: "Cinzel_700Bold" },
  ...
  cardLabel: { position: "absolute", bottom: 14, left: 12, right: 40, color: "#FFF", fontSize: 15, fontFamily: "Cinzel_700Bold", letterSpacing: -0.2 },
  ...
  modalTitle: { color: "#FFF", fontSize: 19, fontFamily: "Cinzel_700Bold", marginTop: 12, textAlign: "center" as const },

...
import { Heart, RefreshCw, MessageCircle, Zap, ArrowRight, Crown } from "lucide-react-native";
      ...
      <View style={s.backdrop}>
        <View style={s.card}>
          ...
          <View style={s.list}>
            ...
            <Item icon={<ArrowRight size={16} color={Colors.crimson} />} label={t("freeTierSwipes")} />
...
const s = StyleSheet.create({
  ...
  title: { color: "#FFF", fontSize: 22, fontFamily: "Cinzel_700Bold", textAlign: "center" as const, marginTop: 12 },
  ...
  itemLabel: { color: "#FFF", fontSize: 13, fontFamily: "Cinzel_600SemiBold" },
  ...
  upgradeTxt: { color: Colors.accent, fontSize: 13, fontFamily: "Cinzel_600SemiBold" },
});
